...
export default function Home() {
  return (
    <main className="min-h-screen bg-slate-50 selection:bg-brand-100">
      {/* Hero Section */}
      <section className="relative overflow-hidden bg-white">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 pt-20 pb-32 sm:pt-32 sm:pb-40 lg:pt-40 lg:pb-48">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <div className="mt-10 flex items-center justify-center gap-x-6">
              ...
              <a href="#sobre-nosotros" className="text-sm font-semibold leading-6 text-slate-900 hover:text-brand-500 transition-colors">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-brand-300/10 rounded-full blur-3xl opacity-50 pointer-events-none" />
      </section>
      ...
      {/* Footer */}
      <footer className="bg-brand-900 border-t border-brand-700/50 py-12">
        <div className="mx-auto max-w-7xl px-6 lg:px-8 text-center text-brand-100/60 text-sm">
